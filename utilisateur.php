                ...
                <div class="card card-post card-round">
                  ...
                  <div class="card-body">
                    ...
                    <div class="separator-solid"></div>
                      <span>
                        <a href="liste_users.php" class="form-control btn" style=" background-color: #062e69; color: white; border-radius: 5px; ">
                          <center>
                ...
                <div class="card">
                 ...
                 <?php 
                  if (isset($_POST['enregistrer'])) {
                    ...
                    $insertion = $db -> prepare("INSERT INTO users(username, tel, fonction, password, date_ajout) VALUES (?, ?, ?, ?, ?)");
                    $insertion -> execute (array ($username, $tel, $fonction, $password, $dates));
                   ...
                   <script>
                    ...
                    <div class="row">
                          ...
                          <div class="card-body" >
                            <div class="row align-items-center">
                              ...
                              <div class="col col-stats ms-3 ms-sm-0">
                                <h1 class="card-title text-white"><center>FORMULAIRE D'AJOUT UTILISATEURS</center></h1>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group form-group-default">
                          ...
                          <input  name="username" type="text" class="form-control" placeholder="Saisissez le nom de l'utilisateur..." />
                        </div>
                      </div>
                    ...
                    <div class="modal-footer border-0">
                      <button type="submit" class="btn" name="enregistrer" style=" background-color: #062e69; color: white; " >
                        Enregistrer
                      </button>
                  </div>
